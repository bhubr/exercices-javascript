...
function isString(estCeUneChaine) {
	if( typeof estCeUneChaine === 'string') {
		return true
	}
	else {
		return false 
...
function isBoolean(estCeUnBoolean) {
	if ( typeof estCeUnBoolean === 'boolean') {
		return true
	}
	else {
		return false 
