...
function isNumber(ofnumber) {
	return typeof ofnumber === 'number'
}
function isString(ofstring) {
	return typeof ofstring === 'string'
}
function isBoolean(ofboolean) {
	return typeof ofboolean === 'boolean'
}
